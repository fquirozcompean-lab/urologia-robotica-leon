...
const Card: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ className = "", children, ...props }) => (
  <div className={"rounded-2xl border border-slate-200 bg-white p-5 shadow-sm "+className} {...props}>{children}</div>
);
...
const MAPS = {
  angeles: "https://www.google.com/maps/search/?api=1&query=Hospital+%C3%81ngeles+Le%C3%B3n+Torre+de+Especialidades+II+Consultorio+425+Av.+Cerro+Gordo+3110+Le%C3%B3n",
  altagracia: "https://www.google.com/maps/search/?api=1&query=Hospital+Christus+Muguerza+Altagracia+Consultorio+724+Le%C3%B3n",
  miyad: "https://www.google.com/maps/search/?api=1&query=Hospital+MIYAD+Blvd.+Vicente+Valtierra+4502+Le%C3%B3n",
};
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <header className="sticky top-0 z-50 backdrop-blur bg-white/80 border-b border-slate-200">
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Button className="bg-teal-700 text-white hover:bg-teal-800" onClick={() => setAskClinicOpen(true)}>Agenda tu cita</Button>
          </nav>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="mt-4 flex items-center gap-3">
                <a href={LINKS.instagram} target="_blank"><Button className="bg-white text-slate-900">Instagram</Button></a>
                <a href={LINKS.facebook} target="_blank"><Button className="bg-white text-slate-900">Facebook</Button></a>
              </div>
      ...
      <section id="opiniones" className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="mt-6">
          <a href={LINKS.doctoralia} target="_blank">
      ...
      <section id="ubicacion" className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-5">
          <Card>
            ...
            <p className="text-sm text-slate-600 mt-1">Torre de Especialidades II, Consultorio 425<br/>Av. Cerro Gordo #3110</p>
            <div className="mt-3 flex flex-wrap gap-2">
              <a href={MAPS.angeles} target="_blank"><Button className="bg-slate-900 text-white">Abrir en Maps</Button></a>
              <a href={waLink(WHATSAPP.angeles, "Hola, quiero agendar en Hospital Ángeles León")} target="_blank"><Button className="bg-teal-700 text-white">WhatsApp</Button></a>
            </div>
          </Card>
          <Card>
            <h3 className="font-semibold">Christus Muguerza Altagracia</h3>
            <p className="text-sm text-slate-600 mt-1">Consultorio 724 • Blvd. Jorge Verbits Campero 761<br/>Fracc. Cañada Alfaro, 37238</p>
            <div className="mt-3 flex flex-wrap gap-2">
              <a href={MAPS.altagracia} target="_blank"><Button className="bg-slate-900 text-white">Abrir en Maps</Button></a>
              <a href={waLink(WHATSAPP.altagracia, "Hola, quiero agendar en Christus Muguerza Altagracia")} target="_blank"><Button className="bg-teal-700 text-white">WhatsApp</Button></a>
            </div>
          </Card>
          <Card>
            <h3 className="font-semibold">Hospital MIYAD</h3>
            <p className="text-sm text-slate-600 mt-1">Consultorio 12 • Blvd. Vicente Valtierra 4502<br/>San Pedro de los Hernández, 37200</p>
            <div className="mt-3 flex flex-wrap gap-2">
              <a href={MAPS.miyad} target="_blank"><Button className="bg-slate-900 text-white">Abrir en Maps</Button></a>
              <a href={waLink(WHATSAPP.miyad, "Hola, quiero agendar en Hospital MIYAD")} target="_blank"><Button className="bg-teal-700 text-white">WhatsApp</Button></a>
            </div>
          </Card>
        </div>
      </section>
      ...
      <footer className="bg-slate-900 text-slate-200">
        <div className="mx-auto max-w-6xl px-4 py-10 grid md:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex flex-wrap gap-4 justify-start md:justify-end text-sm">
            ...
            <a href={LINKS.facebook} target="_blank" className="hover:underline">Facebook</a>
            <a href={LINKS.doctoralia} target="_blank" className="hover:underline">Doctoralia</a>
            <a href={LINKS.linkedin} target="_blank" className="hover:underline">LinkedIn</a>
            <a href={LINKS.researchgate} target="_blank" className="hover:underline">ResearchGate</a>
          </div>
        </div>
  ...
  <div className="fixed inset-0 z-[60] bg-black/50 flex items-center justify-center p-4">
    <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
      ...
      <div className="mt-4 grid gap-3">
        <a href={waLink(WHATSAPP.angeles, "Hola, quiero agendar en Hospital Ángeles León")} target="_blank">
          <Button className="w-full bg-slate-900 text-white">Hospital Ángeles León</Button>
        </a>
        <a href={waLink(WHATSAPP.altagracia, "Hola, quiero agendar en Christus Muguerza Altagracia")} target="_blank">
          <Button className="w-full bg-teal-700 text-white">Christus Muguerza Altagracia</Button>
        </a>
        <a href={waLink(WHATSAPP.miyad, "Hola, quiero agendar en Hospital MIYAD")} target="_blank">
