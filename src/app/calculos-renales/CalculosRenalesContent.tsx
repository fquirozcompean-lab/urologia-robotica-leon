    ...
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="mx-auto max-w-6xl flex justify-between items-center px-4 py-3">
          <Link
            href="/"
            className="font-semibold text-slate-800 hover:text-amber-600 transition text-sm"
          >
        ...
        >
          <div className="mx-auto max-w-3xl px-4 text-center">
            ...
            >
              ...
              <a href={DOCTORALIA} target="_blank" rel="noreferrer">
                <Button className="bg-amber-500 text-white hover:bg-amber-400 text-base px-8 py-3">
                  Doctoralia
                </Button>
              </a>
            </motion.div>
      ...
      <footer className="bg-slate-900 text-slate-200 py-8 text-center">
        ...
        <p className="text-slate-400 text-sm mt-2">
          Urólogo Oncólogo · Cirugía Robótica · Cálculos Renales · León, Guanajuato, México
        </p>
        ...
        <div className="mt-4 flex justify-center gap-6">
          <Link href="/" className="text-amber-400 hover:text-amber-300 text-sm transition">
            ← Inicio
          </Link>
          <Link
