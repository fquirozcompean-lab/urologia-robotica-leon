    ...
    <div className="min-h-screen bg-slate-50 text-slate-800">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <a href={LINKS.doctoralia} target="_blank" rel="noopener noreferrer">
      ...
      <section id="servicios" className="mx-auto max-w-6xl px-4 py-16 scroll-mt-24">
        ...
        <p className="text-slate-600 mt-2">
          Diagnóstico y tratamiento especializado en urología oncológica, funcional y de mínima invasión.
        </p>
        ...
        <div className="mx-auto max-w-6xl px-4 grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <p className="mt-4 text-slate-700 leading-relaxed">
              ...
              Formación en el Instituto Nacional de Ciencias Médicas y Nutrición Salvador Zubirán; Urología Oncológica en el INCAN;
              Cirugía Robótica en el Hospital Israelita Albert Einstein. Certificado por CONAMEU.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
      ...
      <section id="sobre-mi" className="bg-white py-16 scroll-mt-24">
        <div className="mx-auto max-w-6xl px-4 grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href={LINKS.doctoralia} target="_blank" rel="noreferrer" className="text-teal-700 underline">
                Perfil en Doctoralia
              </a>
              <a href={LINKS.linkedin} target="_blank" rel="noreferrer" className="text-teal-700 underline">
                LinkedIn
              </a>
              <a href={LINKS.researchgate} target="_blank" rel="noreferrer" className="text-teal-700 underline">
                ResearchGate
              </a>
            </div>
          </div>
