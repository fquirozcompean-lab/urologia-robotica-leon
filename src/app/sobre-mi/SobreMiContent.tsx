          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                <WASelectorLink mensaje={WA_MSG_HERO} motivo="sobre-mi" className="inline-flex items-center justify-center gap-2 bg-acero text-editorial px-6 py-3 rounded-lg font-bold font-sans hover:bg-acero/80 transition-colors">
                  <WaIcon />
                  Agendar consulta
                </WASelectorLink>
                <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <WASelectorLink mensaje={WA_MSG_FINAL} motivo="sobre-mi" className="flex-1 inline-flex items-center justify-center gap-2 bg-acero text-editorial px-4 py-2.5 rounded-lg font-bold font-sans text-sm hover:bg-acero/80 transition-colors">
                  <WaIcon />
                  WhatsApp
                </WASelectorLink>
                <a
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col items-center gap-4">
              <WASelectorLink mensaje={WA_MSG_FINAL} motivo="sobre-mi" className="inline-flex items-center justify-center gap-2 bg-whatsapp text-white px-8 py-4 rounded-lg font-bold font-sans text-lg hover:bg-whatsapp/85 transition-colors shadow-lg">
                <svg
