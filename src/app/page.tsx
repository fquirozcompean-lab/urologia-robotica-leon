...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      {/* ===== HERO ===== */}
      <section className="relative bg-petroleo text-editorial min-h-[65vh] flex items-center justify-center px-4 py-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl mb-4 font-serif text-editorial/90 max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gris-premium max-w-3xl mx-auto font-serif">
              Atención integral en urología oncológica, reconstructiva y salud sexual masculina
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-petroleo font-sans">
                Subespecialidad en Urología Oncológica
              </h3>
              <p className="text-gris-premium font-serif text-[15px] leading-relaxed">
                Entrenamiento INCan (Instituto Nacional de Cancerología).
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-sm font-serif">
                <a href="mailto:aqc_alejandro@hotmail.com" className="hover:text-quirurgico transition-colors">
                  aqc_alejandro@hotmail.com
                </a>
              </p>
            </div>
