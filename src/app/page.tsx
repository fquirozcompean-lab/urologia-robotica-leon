...
export default function UrologiaRoboticaLeon() {
  ...
  const faqs = [
    ...
    { q: "¿En qué hospitales atiende?", a: "Hospital Ángeles León (consultorio 615, Torre II) de lunes a martes y jueves, y Hospital Christus Muguerza Altagracia de miércoles a viernes." },
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  ...
                  <a
                    href={waLink("5214776390492", "Hola Dr. Quiroz, quiero agendar una consulta.")}
                    target="_blank"
                    rel="noreferrer"
                  >
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {Object.keys(MAPS).map((key) => (
              <Card key={key}>
                ...
                {key === "altagracia" && (
                  <p className="text-sm text-slate-500 mt-1">Consultorio 724 · Mié, Vie</p>
                )}
                <div className="flex gap-2 mt-3 flex-wrap">
                  ...
                  <a
                    href={waLink(WHATSAPP[key], `Hola Dr. Quiroz, quiero agendar una consulta en ${HOSPITAL_LABELS[key]}.`)}
                    target="_blank"
                    rel="noreferrer"
                  >
      ...
      <footer className="bg-slate-900 text-slate-200 py-8 text-center">
        ...
        >
          © {new Date().getFullYear()} Dr. Alejandro Quiroz Compeán | Urología Robótica León
        </motion.p>
