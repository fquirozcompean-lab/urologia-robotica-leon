        ...
        <section className="relative bg-petroleo text-editorial py-24 px-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <WASelectorLink mensaje={WA_MSG} motivo="cancer-renal">
                <motion.div
                  whileHover={{ scale: 1.03 }}
                  whileTap={{ scale: 0.97 }}
                        ...
                        >
                          ...
                          {isOpen && (
                            ...
                            >
                              ...
                              <div className="mt-5">
                                <WASelectorLink mensaje={`Hola Dr. Quiroz, quiero información sobre ${t.name} para cáncer renal.`} motivo="cancer-renal-tratamiento">
        ...
        <section className="bg-editorial border-l-4 border-dorado py-10 px-6 md:px-12 my-12 rounded-r-xl">
          <div className="max-w-3xl">
            ...
            <p className="font-serif text-gris-profundo mb-6">
              Si ya tienes un diagnóstico de tumor renal, una segunda opinión puede
              revelar opciones de preservación del riñón que no siempre se ofrecen de
              primera instancia. Conoce todas tus alternativas antes de decidir.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <WAButton
                mensaje="Hola Dr. Quiroz, tengo un diagnóstico de tumor en el riñón y quisiera solicitar una segunda opinión."
                motivo="cross-link-renal-segunda-opinion"
                variant="primary"
              >
